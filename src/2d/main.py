...
from fipy import CellVariable, TransientTerm, DiffusionTerm, Viewer, FaceVariable, ImplicitSourceTerm, Variable, ExplicitDiffusionTerm
...
# T = CellVariable(name="Temperature", mesh=mesh, value=0., hasOld=True)
...
# mesh = generate_mesh_2d(0.02, 0.01, 100*4, 50*4)
# x_cell, y_cell = mesh.cellCenters
# T = CellVariable(name="Temperature", mesh=mesh, value=T_amb, hasOld=True)
...
# x_cell, y_cell = mesh.cellCenters
# T = CellVariable(name="Temperature", mesh=mesh, value=T_out, hasOld=True)
...
# VERDICT: Implementation NOT correct. Reason unknown. 
...
measure_times = [0, 1, 2, 10, 30, 40, 100, 150, 200, 210, 220, 300, 400, 434, 450, 800, 1000, 2000, 5000, 10000, 20000, 25000, 29000]  # Time points to measure temperature (t / dt)
...
#         # print(f"Sweep Time: {t:.2f} / {run_time:.2f} s --- Residual: {res}")
#     # if timestep % 10 == 0:
#     #     if __name__ == "__main__":
#     #         viewer.plot()
#     print(f"STEP! Time: {t:.2f} / {run_time:.2f} s")
